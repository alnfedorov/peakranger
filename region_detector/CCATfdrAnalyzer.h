...
namespace ccat_aux {
    ...
    private:
        ...
        double ComputeLocalFDR(std::vector<ccat_aux::peak_t> &l1Peaks, std::vector<ccat_aux::peak_t> &l2Peaks,
                               std::vector<double> &q, std::vector<double> &value,
                               const ccat_aux::ccat_config_t &config, size_t tagCount,
                               size_t binCount);
        ...
        int
        ProcessOneChrom(ccat_aux::chr_t &chrom, double l1Ratio, double l2Ratio, const ccat_aux::ccat_config_t &config);
