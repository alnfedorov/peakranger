...
namespace options {
    ...
    ccat_cmd_option_parser::ccat_cmd_option_parser(int argc, char **argv, const std::string &version) :
            cmd_option_parser(argc, argv), version(version), _split(false), _html(false),
            all("\nccat " + version + "\n\nUsage"), popt() {
        outputNum = 100000;
        _binlength = 10000;
        opt other("Other");
