...
template<typename R>
reads::ReadPair<R>::ReadPair() :
        mR1(), mR2() {
}

template<typename R>
reads::ReadPair<R>::ReadPair(const R &r1, const R &r2) :
        mR1(r1), mR2(r2) {
}
...
template<typename R>
R &reads::ReadPair<R>::r1() {
    return mR1;
}

template<typename R>
R &reads::ReadPair<R>::r2() {
    return mR2;
}

template<typename R>
void reads::ReadPair<R>::add(const R &r1, const R &r2) {
    mR1 = r1;
    mR2 = r2;
}
